...
exec > >(tee >(systemd-cat --identifier=odin-encrypted-backup-gen --priority=info) >&1)
...
LOCK="/home/adam/Locks/odin-encrypted-tar-job.lock"
...
nice -n 10 ionice -c2 -n7 \
  python -m scripts.encrypt_tarball_base